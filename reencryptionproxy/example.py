...
import pickle
from umbral import (
    SecretKey, Signer, CapsuleFrag, VerifiedKeyFrag,
...
alices_test=SecretKey.random()
alices_public_key = alices_test.public_key()
alices_secret_key=SecretKey.from_bytes(alices_test.to_secret_bytes())
print(alices_secret_key.to_secret_bytes())
print(bytes(alices_public_key))
