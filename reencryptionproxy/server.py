...
from umbral import Capsule, PublicKey, SecretKey, Signer, VerifiedKeyFrag, decrypt_original, encrypt, generate_kfrags, reencrypt
...
def decryptHandler():
    ...
    bytes_data = base64.b64decode(data['public_key'].encode('utf-8'))
    capsule_text = fromBase64(data['capsule'])
    capsule=Capsule.from_bytes(capsule_text)
