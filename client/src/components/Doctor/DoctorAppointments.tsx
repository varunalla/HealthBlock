       ...
       <div className="flex flex-col  px-4 lg:px-8 ">
         <div className="bg-gray-100 py-4 px-4 flex items-center justify-between">
           ...
           <div className="flex items-center">
            <label htmlFor="date" className="mr-2 text-sm font-medium">Filter by date:</label>
            <input type="date" id="date" name="date" className="border border-gray-300 rounded-md px-4 py-2" />
            <button className="bg-blue-500 text-white font-bold rounded-md px-4 py-2 ml-2">Filter</button>
           </div>
         </div>
